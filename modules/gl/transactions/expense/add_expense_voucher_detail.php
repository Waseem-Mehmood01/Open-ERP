    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
				 <form class="form-horizontal" role="form" method="POST" action="" name="frmAddExpense" id="frmAddExpense">
      ...
      <div class="col-sm-8">          
        <input type="text" class="form-control" id="expense_ammount" name="expense_ammount" placeholder="Expense Ammount">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary addExpenseDetail">Save</button>
            </div>
			</form>
        </div>
    </div>
...
$(document).ready(function(){
	$(".addExpenseDetail").on("click",function(){
		$.ajax({
			data: $("#frmAddExpense").serialize(),
			method: "post",
			url: "ajax_helpers/ajax_add_voucher_detail.php",
