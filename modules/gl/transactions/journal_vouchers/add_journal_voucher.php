...
?><!-- Content Header (Page header) -->
        <section class="content-header">
          <h1>
          	Journal Voucher
            <small>Create New Journal Voucher</small>
          </h1>
          <ol class="breadcrumb">
        ...
        <section >
          ...
          <div class="box">
             <div class="box-header with-border">
              <h3 class="box-title">Create New Journal Voucher</h3>
  ...
  <form method="POST" action="" role="form">
          ...
          <div class="row ">
            <div class="col-sm-6"> 
              ...
              <b>Journal Voucher Date:</b><input  name="voucher_date" type="text"  required="required" class="form-control date-picker" value="">
			 
            </div><!-- /.col -->
			<div class="col-sm-6"> 

              <b>Memo:</b><input  name="voucher_description" type="text" class="form-control" value="">
      		...
      		<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
      			<table class="table table-bordered table-hover">
					...
					<tbody>
						<tr>
							...
							<td><select class="form-control" name="account_id[]" id="account_id_1" required>
								...
								<?php
									...
									$res = DB::query($sql);
									foreach($res as $row){
											echo "<option value ='".$row['account_id']."'>".$row['account_desc_short']."</option>";
									} ?>
							</select>
							</td>
						...
						<tr>
							<td><input class="case" type="checkbox"/></td>
							<td><select class="form-control" name="account_id[]" id="account_id_2" required>
								<option value="">Select Account</option>
								<?php
									$sql = "select * from sa_test_coa where account_status='Active'";
									$res = DB::query($sql);
