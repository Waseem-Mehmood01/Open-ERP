...
<?php
$text='"Are you sure to put this sale to delevered?"';
...
$tbl->addCell("<a class='pull btn btn-default btn-xs' href ='?route=modules/sales/view_sale_detail&sale_id=".$list_voucher_expense['sale_id']."'>Detail&nbsp;<span class='glyphicon glyphicon-edit'></span></a>&nbsp;
<a class='pull btn btn-success btn-xs' href ='?route=modules/sales/return_sale&sale_id=".$list_voucher_expense['sale_id']."&is_return=0&ref_no=".$list_voucher_expense['ref_no']."' onclick='return confirm(".$text.");'>Push Delevered&nbsp;<span class='glyphicon glyphicon-edit'></span></a>  
<a class='pull btn btn-danger btn-xs' href ='?route=modules/sales/return_sale&sale_id=".$list_voucher_expense['sale_id']."&delete=1' onclick='return confirm(".$text2.");'>Delete&nbsp;<span class='glyphicon glyphicon-trash'></span></a> ");
}
 ...
 <!-- Content Header (Page header) -->
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">List OF All Return Sale</li>
          </ol>
        </section>
