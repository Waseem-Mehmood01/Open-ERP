    ...
    JOIN sa_test_coa_groups cg 
        ON (c.`account_group` = cg.`group_id`)";
							...
							if($purchase_detail['unit']=='KG') {
								...
								echo " MWeight";
							} ?>" value="<?php echo $purchase_detail['weight']; ?>" name="weight[]" id="weight_<?php echo $i; ?>" type="text" placeholder="Weight" onkeypress="return IsNumeric(event);" ondrop="return false;"  /></td>
							...
							<td><input  value="<?php echo $purchase_detail['bags']; ?>" class="form-control" name="bags[]" id="bags_<?php echo $i; ?>" type="number" placeholder="Quantity"  onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"/></td>
							<td><input  value="<?php echo $purchase_detail['rate']; ?>" class="form-control changesNo" name="rate[]" id="rate_<?php echo $i; ?>" type="number" placeholder="Rate" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"/></td>
